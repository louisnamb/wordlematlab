function[selectedWord] = chosen_range()
    ...
    word = input("How many letters should the word be? 4-10 ");
    switch word
        case 4
    ...
    fprintf("Welcome to Worlde.\nRULES:\n-\tYou have %d guesses to find the mystery word!\n-\tYou'll be given hints to whats right\n-\tThe dictionary of words includes random but commonly used words.\nGood Luck!", length(selectedWord));
end